...
function Card({ className, ...props }: React.ComponentProps<"div">) { return <div data-slot="card" className={cn("flex flex-col gap-6 rounded-md border-2 bg-card py-6 text-card-foreground shadow-[6px_6px_0_0_var(--shadow-color)]", className)} {...props} /> }
